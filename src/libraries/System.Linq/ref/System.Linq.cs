...
#nullable restore
        ...
        public static System.Collections.Generic.IEnumerable<T> InfiniteSequence<T>(T start, T step) where T : System.Numerics.IAdditionOperators<T, T, T> { throw null; }
        ...
        public static System.Collections.Generic.IEnumerable<T> Sequence<T>(T start, T endInclusive, T step) where T : System.Numerics.INumber<T> { throw null; }
