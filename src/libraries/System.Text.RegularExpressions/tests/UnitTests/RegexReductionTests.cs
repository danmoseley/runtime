...
namespace System.Text.RegularExpressions.Tests
{
    public class RegexReductionTests
    {
        ...
        public void PatternsReduceIdentically(string actual, string expected, int options = 0)
        {
            ...
            string actualStr = RegexParser.Parse(actual, (RegexOptions)options, CultureInfo.InvariantCulture).Root.ToString();
            string expectedStr = RegexParser.Parse(expected, (RegexOptions)options, CultureInfo.InvariantCulture).Root.ToString();
