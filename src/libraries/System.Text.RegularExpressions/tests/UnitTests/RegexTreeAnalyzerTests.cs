...
namespace System.Text.RegularExpressions.Tests
{
    public class RegexTreeAnalyzerTests
    {
        ...
        public void SimpleString()
        {
            ...
            RegexNode rootCapture = AssertNode(analysis, tree.Root, RegexNodeKind.CaptureGroup, atomicByAncestor: true, backtracks: false, captures: true, inLoop: false);
        ...
        public void AlternationWithCaptures()
        {
            ...
            RegexNode rootCapture = AssertNode(analysis, tree.Root, RegexNodeKind.CaptureGroup, atomicByAncestor: true, backtracks: false, captures: true, inLoop: false);
            RegexNode implicitAtomic = AssertNode(analysis, rootCapture.Child(0), RegexNodeKind.AtomicGroup, atomicByAncestor: true, backtracks: false, captures: true, inLoop: false);
            ...
            RegexNode ghiCapture = AssertNode(analysis, alternation.Child(2), RegexNodeKind.CaptureGroup, atomicByAncestor: true, backtracks: false, captures: true, inLoop: false);
            ...
            RegexNode eCapture = AssertNode(analysis, def.Child(1), RegexNodeKind.CaptureGroup, atomicByAncestor: false, backtracks: false, captures: true, inLoop: false);
        ...
        public void LoopsReducedWithAutoAtomic()
        {
            ...
            RegexNode aStar = AssertNode(analysis, concat.Child(0), RegexNodeKind.AtomicLoopOne, atomicByAncestor: false, backtracks: false, captures: false, inLoop: false);
            ...
            RegexNode bStarCapture = AssertNode(analysis, concat.Child(2), RegexNodeKind.CaptureGroup, atomicByAncestor: false, backtracks: false, captures: true, inLoop: false);
            RegexNode cStar = AssertNode(analysis, concat.Child(3), RegexNodeKind.AtomicLoopOne, atomicByAncestor: true, backtracks: false, captures: false, inLoop: false);

            RegexNode bStar = AssertNode(analysis, bStarCapture.Child(0), RegexNodeKind.AtomicLoopOne, atomicByAncestor: false, backtracks: false, captures: false, inLoop: false);
        }
        ...
        public void AtomicGroupAroundBacktracking()
        {
            ...
            RegexNode rootCapture = AssertNode(analysis, tree.Root, RegexNodeKind.CaptureGroup, atomicByAncestor: true, backtracks: true, captures: true, inLoop: false);
            ...
            RegexNode atomic = AssertNode(analysis, rootConcat.Child(2), RegexNodeKind.AtomicGroup, atomicByAncestor: false, backtracks: false, captures: false, inLoop: false);
        ...
        public void LoopsAroundVariousConstructs()
        {
            ...
            RegexNode loopCapture = AssertNode(analysis, loop.Child(0), RegexNodeKind.CaptureGroup, atomicByAncestor: false, backtracks: true, captures: true, inLoop: true);
            ...
            RegexNode abStar = AssertNode(analysis, lazyLoopConcat.Child(0), RegexNodeKind.AtomicLoopSet, atomicByAncestor: false, backtracks: false, captures: false, inLoop: true);
